		...
		switch ( extension ) {
			...
			case '3dm':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.parse( contents, function ( object ) {
						...
						editor.execute( new AddNodeCommand( editor, object ) );
			...
			case 'amf':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					editor.execute( new AddNodeCommand( editor, amfobject ) );
			...
			case 'dae':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					editor.execute( new AddNodeCommand( editor, collada.scene ) );
			...
			case 'glb':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.parse( contents, '', function ( result ) {
						...
						editor.execute( new AddNodeCommand( editor, scene ) );
			...
			case 'ifc':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					editor.execute( new AddNodeCommand( editor, model.mesh ) );
			...
			case 'mpd':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					loader.parse( event.target.result, undefined, function ( group ) {
						...
						editor.execute( new AddNodeCommand( editor, group ) );
			...
			case 'xyz':
				...
				reader.addEventListener( 'load', async function ( event ) {
					...
					editor.execute( new AddNodeCommand( editor, points ) );
			...
			case 'object':
				...
				loader.parse( data, function ( result ) {
					...
					if ( result.isScene ) {
						...
						editor.execute( new AddNodeCommand( editor, result ) );
