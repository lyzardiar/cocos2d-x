...
function Viewport( editor ) {
	...
	function onDoubleClick( event ) {
		...
		if ( intersects.length > 0 ) {
			...
			signals.nodeFocused.dispatch( intersect.object );
	...
	signals.rendererCreated.add( function ( newRenderer ) {
		...
		*/
		container.dom.appendChild( renderer.canvas );
	...
	signals.nodeFocused.add( function ( object ) {
	...
	signals.nodeRemoved.add( function ( object ) {
