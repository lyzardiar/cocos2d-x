...
function SidebarScene( editor ) {
	...
	function getNodeType( node ) {
		...
		if ( node.$$.ptrType.name === 'cc.Scene' ) return 'Scene';
		if ( node.$$.ptrType.name === 'cc.Camera' ) return 'Camera';
		if ( node.$$.ptrType.name === 'cc.DirectionLight'  ) return 'Light';
		if ( node.$$.ptrType.name === 'cc.PointLight'  ) return 'Light';
		if ( node.$$.ptrType.name === 'cc.SpotLight'  ) return 'Light';
		if ( node.$$.ptrType.name === 'cc.AmbientLight'  ) return 'Light';
		if ( node.$$.ptrType.name === 'cc.Mesh' ) return 'Mesh';
	...
	function buildHTML( object ) {
		...
		var html = `<span class="type ${ getNodeType( object ) }"></span> ${ escapeHTML( object.name ) }`;
	...
	outliner.onChange( function () {
		...
		editor.selectByPtr( parseInt( outliner.getValue() ) );
